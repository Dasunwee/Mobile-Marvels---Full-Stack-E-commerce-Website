...
document.getElementById('loginForm').addEventListener('submit', function(event) {
  ...
  if (isValid) {
    ...
    fetch('http://localhost/MobileMarvels/Loggin/login.php', {  // Make sure the path matches your actual PHP file
      method: 'POST',
      body: formData
    })
    ...
    .then(data => {
      if (data.success) {
        ...
        window.location.href = "http://localhost/MobileMarvels/Loggin/checkout.html";
      } else {
