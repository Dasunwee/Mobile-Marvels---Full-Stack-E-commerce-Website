...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/MobileMarvels/Products/productsstyle.css">
...
<div id="myNav" class="overlay">
        <div class="overlay-content">
            <a href="http://localhost/MobileMarvels/index.html">Home</a>
            <a href="http://localhost/MobileMarvels/Products/products.php">Products</a>
            <a href="http://localhost/MobileMarvels/Contact/contact.html">Contact Us</a>
            <a href="http://localhost/MobileMarvels/Aboutus/aboutus.html">About Us</a>
            <a href="http://localhost/MobileMarvels/Loggin/loggin.html">Login</a>
            <a href="http://localhost/MobileMarvels/Register/register.html">Register</a>
    ...
    <div class="main">
     ...
     <div class="superhero-text">
            ...
            <p>Compare the latest smartphones side by side to find the perfect device for your needs.Our detailed comparison tool allows you to evaluate key features, specifications, and user ratings for the phones
             you are interested in  Click the button below to start comparing and make an informed decision!</p>
         <a href="http://localhost/MobileMarvels/Compare/compare.html">
